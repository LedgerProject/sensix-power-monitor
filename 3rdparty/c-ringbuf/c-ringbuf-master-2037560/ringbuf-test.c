...
main(int argc, char **argv)
{
    ...
    struct ringbuf_t *rb1 = malloc(sizeof(struct ringbuf_t));
	ringbuf_init(rb1);
    ...
    struct ringbuf_t rb2_value;
    ringbuf_init(&rb2_value);
    struct ringbuf_t *rb2 = &rb2_value;
    ...
    START_NEW_TEST(test_num);
    struct ringbuf_t rb3_value;
    ringbuf_init(&rb3_value);
    struct ringbuf_t *rb3 = &rb3_value;
